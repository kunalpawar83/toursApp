...
/* eslint-disable*/
var hiddenAlert = exports.hiddenAlert = function hiddenAlert() {
  var el = document.querySelector('.alert');
  if (el) {
    el.parentElement.replaceChild(el);
  }
};
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 7:
          ...
          (0, _alert.showAlert)('error', 'error logging out! Try agin.');
        case 10:
        case "end":
